        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-1">
              Welcome to Revolaunch
            </h1>
            <p className="text-sm text-muted-foreground">
              Sign in to manage your startups and track your launch
            </p>
          </div>
          ...
          <motion.div
            ...
            className="rounded-2xl border subtle-border surface p-6 space-y-4"
          >
            {/* Google button */}
            ...
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <span className="w-full border-t subtle-border" />
              </div>
              <div className="relative flex justify-center text-xs">
                <span className="px-3 surface text-muted-foreground">or</span>
              </div>
            </div>
          ...
          >
            ...
            <span className="text-foreground font-medium">Sign in to get started</span>
          </motion.p>
